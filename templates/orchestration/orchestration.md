...
**Discovery:** Follow the Codebase Discovery Protocol (Section 2) fully, including generating compaction if none exists. The compact summaries use far fewer tokens than raw source, preserving context for the explanation itself.
